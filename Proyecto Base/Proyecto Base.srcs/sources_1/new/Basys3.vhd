...
signal led3 : std_logic_vector(2 downto 0); --ELIMINAR
signal status_test : std_logic_vector(2 downto 0); --ELIMINAR
-- Fin de la declaración de los señales.

begin

led(2) <= status_test(0); --C. ELIMINAR
led(1) <= status_test(1); --Z. ELIMINAR
led(0) <= status_test(2); --N. ELIMINAR
...
inst_CPU: CPU port map(
    ...
    dis         => dis,
    status_test => status_test --ELIMINAR
    );
